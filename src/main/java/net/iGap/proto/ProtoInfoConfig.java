  ...
  public  static final class InfoConfigResponse extends
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      result = result && (getDebugMode()
          == other.getDebugMode());
      result = result && (getDefaultTimeout()
          == other.getDefaultTimeout());
      result = result && (getOptimizeMode()
          == other.getOptimizeMode());
      result = result && (getMaxFileSize()
          == other.getMaxFileSize());
      result = result && (getCaptionLengthMax()
          == other.getCaptionLengthMax());
      result = result && (getMessageLengthMax()
          == other.getMessageLengthMax());
      result = result && (getGroupAddMemberLimit()
          == other.getGroupAddMemberLimit());
      result = result && (getChannelAddMemberLimit()
          == other.getChannelAddMemberLimit());
      result = result && getMicroServiceList()
          .equals(other.getMicroServiceList());
      result = result && debugger_ == other.debugger_;
